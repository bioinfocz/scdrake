---
title: "scdrake configs: a general overview"
...
output:
  BiocStyle::html_document:
    ...
    toc_float: true
vignette: >
  %\VignetteIndexEntry{scdrake configs: a general overview}
...
(by default if you run e.g. `run_single_sample()` or `drake::r_make("_drake_single_sample.R")`).
