...
This option enables spatial extension as selection of spatially variable genes (SVGS), pseudo tissue visualization and other visualization options for manual annotation.
...
Which dimension reduction use to show result of manual annotation. 
