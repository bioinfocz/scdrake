...
**Type:** character scalar (`"scran"` | `"sctransform"`)
...
See `vignette("pipeline_overview")` for more details.
...
A metric used to find HVGs. See <http://bioconductor.org/books/release/OSCA/feature-selection.html> for more details.
...
- An integer scalar for `HVG_SELECTION: "top"`.
...
[here](http://bioconductor.org/books/release/OSCA/cell-cycle-assignment.html#removing-cell-cycle-related-genes).
...
- `"elbow"`: use the
  [elbow point method](http://bioconductor.org/books/release/OSCA/dimensionality-reduction.html#using-the-elbow-point).
- `"technical_noise"`: use the
  [technical noise](http://bioconductor.org/books/release/OSCA/dimensionality-reduction.html#using-the-technical-noise).
...
[t-stochastic neighbor embedding](https://bioconductor.org/books/release/OSCA/dimensionality-reduction.html#t-stochastic-neighbor-embedding)
...
Parameters for [graph-based clustering](https://bioconductor.org/books/release/OSCA/clustering.html#clustering-graph).
...
However, for a full overview, you have to inspect the [source code](R/plans_single_sample.R) of the
