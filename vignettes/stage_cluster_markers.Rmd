...
whether you run `run_single_sample()` or `run_integration()`.
...
- This will override `COMMON_PARAMS` in `CLUSTER_MARKERS_SOURCES_DEFAULTS`.
...
- This will override `PARAMS_T` in `CLUSTER_MARKERS_SOURCES_DEFAULTS`.
...
However, for a full overview, you have to inspect the [source code](R/plans_common.R) of the
