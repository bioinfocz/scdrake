...
Taken from [OSCA](https://bioconductor.org/books/release/OSCA/marker-detection.html), slightly modified:
...
[pairwise fashion](https://bioconductor.org/books/release/OSCA/marker-detection.html#pairwise-tests-between-clusters)
...
- [Looking for any differences](https://bioconductor.org/books/release/OSCA/marker-detection.html#looking-for-any-differences):
...
- [Finding cluster-specific markers](https://bioconductor.org/books/release/OSCA/marker-detection.html#finding-cluster-specific-markers):
...
- [Balancing stringency and generality](https://bioconductor.org/books/release/OSCA/marker-detection.html#balancing-stringency-and-generality):
...
[Blocking factors](https://bioconductor.org/books/release/OSCA/marker-detection.html#marker-batch)
