...
[integration diagnostics](https://bioconductor.org/books/release/OSCA/integrating-datasets.html#correction-diagnostics).
...
However, for a full overview, you have to inspect the [source code](R/plans_integration.R) of the
