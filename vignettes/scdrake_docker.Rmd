...
**Important notice for Linux hosts**
...
(see the [official FAQ](https://docs.docker.com/desktop/faqs/linuxfaqs/) on DD and Linux). Otherwise, in Docker Desktop,
you won't be able to run RStudio Server. **See [here](https://docs.docker.com/desktop/faqs/linuxfaqs/#context)
how to quickly switch to DE if you have installed DD.**
...
## Running interactively ("run and forget")
...
Note for Linux hosts using Docker Desktop: omit the `-u rstudio` parameter.
