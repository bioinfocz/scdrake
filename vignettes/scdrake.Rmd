...
For a more schematic overview of pipelines and stages see `vignette("pipeline_overview")`. Advanced users might be
interested in looking into source code of `{scdrake}`'s [plans](https://github.com/bioinfocz/scdrake/tree/main/R)
