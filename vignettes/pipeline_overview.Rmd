...
[here](https://bioconductor.org/books/release/OSCA.basic/quality-control.html).
...
- Calculation of per-cell QC metrics (`scater::perCellQCMetrics()`,
  [theory](https://bioconductor.org/books/release/OSCA.basic/quality-control.html#common-choices-of-qc-metrics)):
  - Number of UMI.
...
- Two methods for cell filtering (optional):
  - Dataset-sensitive filtering, based on the median absolute deviation (MAD) from the median value of
     ...
     ([theory](https://bioconductor.org/books/release/OSCA.basic/quality-control.html#quality-control-outlier).
  - Custom filtering, based on fixed thresholds. For "number of UMI" metric, both upper and lower bounds are used
    ([theory](https://bioconductor.org/books/release/OSCA.basic/quality-control.html#fixed-qc).
...
The only difference is the **user selection of a final integration method which will be used downstream.**
