...
[here](https://bioconductor.org/books/3.15/OSCA.basic/quality-control.html).
...
- [Dimensionality reduction](https://bioconductor.org/books/3.15/OSCA.basic/dimensionality-reduction.html#non-linear-methods-for-visualization):
  - PCA
...
More information can be found in this [OSCA chapter](http://bioconductor.org/books/3.15/OSCA.multisample).
