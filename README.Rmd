...
## Using a Docker image (_recommended_)
...
The complete guide to the usage of `{scdrake}`'s Docker image can be found at
...
Below you can find just the basic command to download the image.
