...
**Note for Mac users with M1 chipsets**: you can use the `arm64` version of the image:

```{r docker_latest, include = FALSE}
out <- c(
  "\n",
  "```",
  glue::glue("docker pull {DOCKER_IMAGE_STABLE_ARM64}"),
  glue::glue("docker pull {DOCKER_IMAGE_LATEST_ARM64}"),
  "```",
  "\n"
)
```
