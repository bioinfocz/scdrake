...
[![Pipeline diagram](https://img.shields.io/badge/Pipeline%20diagram-Show-informational)](https://github.com/bioinfocz/scdrake/blob/main/diagrams/pipeline_diagram.pdf)
...
`{scdrake}` is currently not released on [CRAN](https://cran.r-project.org), however, you can install its latest
