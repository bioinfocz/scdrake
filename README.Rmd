...
out <- scdrake::wrap_code(c(
  ...
  glue::glue("singularity pull docker:{DOCKER_IMAGE_STABLE_ARM64}"),
  glue::glue("docker pull {DOCKER_IMAGE_LATEST_ARM64}"),
  glue::glue("singularity pull docker:{DOCKER_IMAGE_LATEST_ARM64}")
))
```
...
Then see the initial three steps in the[Get Started vignette](https://bioinfocz.github.io/scdrake/articles/scdrake_docker.html)
