...
```{r, results = "asis"}
par <- other_params$dimred_plots[1, ]

for (i in seq_along(par$plot_highlighted)) {
  scdrake::md_header(stringr::str_to_upper(par$plot_dimreds[i]), 3)
  print(par$plot_highlighted[[i]])
}
```
