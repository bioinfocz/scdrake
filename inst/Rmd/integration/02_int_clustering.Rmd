...
generate_dimred_plots_section(
  ...
  clustering_names = cfg$INT_CLUSTERING_REPORT_CLUSTERING_NAMES,
  selected_markers = selected_markers_plots_int_final,
  dimred_plots_clustering = dimred_plots_clustering,
  dimred_plots_other_vars = dimred_plots_other_vars,
  selected_markers_files_rel_start = fs::path_dir(cfg$INT_CLUSTERING_REPORT_HTML_FILE)
)
```
