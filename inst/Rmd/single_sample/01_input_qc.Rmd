...
if (empty_droplets_enabled) {
  abline(h = empty_droplets_enabled, col = "firebrick", lty = 2)
  legend(
    "bottomleft",
    lty = 2,
...
```{r, child = here::here("Rmd/single_sample/01_input_qc_empty_droplets.Rmd"), eval = tryCatch(empty_droplets_enabled, error = function(e){})}
```
