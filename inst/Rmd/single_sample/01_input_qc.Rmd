...
# 10x Genomics Cell Ranger data input

The Cell Ranger pipeline from 10x Genomics will process the raw sequencing data and produce a matrix of UMI counts.
...
Remove barcodes representing empty droplets from the dataset.
