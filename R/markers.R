...
#' @title Prepare a list of marker source parameters.
#' @param marker_source A named list.
#' @param marker_source_name A character scalar.
#' @param marker_default_params A named list.
#' @return A modified `marker_source` list.
#'
#' @concept sc_markers
#' @rdname prepare_markers_source
#' @export
prepare_markers_source_params <- function(marker_source, marker_source_name, marker_default_params) {
...
#' @param marker_sources A list of marker sources.
#' @return A modified `marker_sources` list.
#'
#' @concept sc_markers
#' @rdname prepare_markers_source
#' @export
prepare_markers_sources_params <- function(marker_sources, marker_default_params) {
  purrr::map(
    names(marker_sources),
    ~ prepare_markers_source_params(marker_sources[[.]], marker_source_name = ., marker_default_params = marker_default_params)
